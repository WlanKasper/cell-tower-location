...
This is a cell tower geolocation converter on the OpenAPI 3.1.0 specification.
...
- API version: 0.1.0
- Build date: 2023-08-27T16:04:24.135514Z[Etc/UTC]
...
```
cargo run --example client DecodeWgs84
cargo run --example client EncodeWgs84
```
...
------------- | ------------- | -------------
[**decodeWGS84**](docs/coordinates_api.md#decodeWGS84) | **POST** /wgs84/decode | WGS84 decode endpoint
[**encodeWGS84**](docs/coordinates_api.md#encodeWGS84) | **POST** /wgs84/encode | WGS84 encode endpoint
